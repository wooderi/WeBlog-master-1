        ...
        <div class="grid grid-cols-4">
            ...
            <div class="col-span-4 px-3 md:col-span-3 sm:col-span-4">
                ...
                <div class="flex items-center mb-5 text-gray-600 font-bold text-2xl">
                    <svg class="w-6 h-6 mr-2 text-gray-600 inline dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                ...
                <div v-if="articles && articles.length > 0" class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div v-for="(article, index) in articles" :key="index"
                        ...
                        <a @click="goArticleDetail(article.id)" class="cursor-pointer">
                            <MinioImage class="rounded-t-lg h-50 w-full" :src="article.titleImage" :alt="article.title" />
                        </a>
                        <div class="p-5">
                            <a @click="goArticleDetail(article.id)" class="cursor-pointer">
                ...
                <div v-else>
                    <div class="flex flex-col items-center mb-5">
                        ...
                        <p class="text-gray-600 mt-5 text-lg font-blod">未找到相关文章，换个关键词试试吧~</p>
                    </div>
                </div>
...
function getArticles(currentNo) {
    console.log('获取搜索结果数据，关键词:', keyword.value)
