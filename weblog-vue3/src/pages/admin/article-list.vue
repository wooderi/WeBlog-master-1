    ...
    <el-dialog v-model="isArticlePublishEditorShow" fullscreen="true" :show-close="false" :modal="false">
        ...
        <el-form :model="form" ref="publishArticleFormRef" label-position="top" :size="large" :rules="rules">
            ...
            <el-form-item label="摘要" prop="description">
                <el-input v-model="form.description" :rows="3" type="textarea" placeholder="请输入文章摘要" maxlength="500" show-word-limit />
            </el-form-item>
...
import { Search, RefreshRight, Picture, Plus, Edit, View, Delete, EditPen, Promotion } from '@element-plus/icons-vue'
...
const handleTitleImageChange = (file) => {
    ...
    uploadFile(formData).then((e) => {
        ...
        console.log('文件上传成功，返回的URL:', e.data.url);
