...
import '@/assets/css/custom/category-tag.css' // 引入分类和标签页面自定义样式
import 'animate.css';
...
// 导入Minio图片URL修复工具
import { MinioImageDirective, fixMinioImageUrl } from '@/composables/minioImageFixer'
...
// 注册Minio图片修复指令
app.directive('minio-img', MinioImageDirective);

// 全局属性，提供修复图片URL的函数
app.config.globalProperties.$fixMinioImageUrl = fixMinioImageUrl;

// 全局注册Minio图片组件
app.component('MinioImage', MinioImage);
