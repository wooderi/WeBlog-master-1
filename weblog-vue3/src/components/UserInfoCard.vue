<template>
    ...
    <div class="mb-3 w-full bg-skyblue-gradient border border-sky-300 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex justify-end px-4 pt-4">
        </div>
        <div class="flex flex-col items-center pb-6">
            <div class="w-15 h-15 mb-3 rounded-full shadow-lg overflow-hidden">
                <MinioImage 
                    :src="$store.state.setting.avatar" 
                    :alt="$store.state.setting.author" 
